...
export OF_MAINTAINER=EAZYBLACK

# Build environment stuffs
export FOX_BUILD_DEVICE="Pixel8"
export ALLOW_MISSING_DEPENDENCIES=true
export FOX_USE_TWRP_RECOVERY_IMAGE_BUILDER=1
export TARGET_DEVICE_ALT="Pixel8, GooglePixel8, shiba, Shiba"
export FOX_TARGET_DEVICES="Pixel8, GooglePixel8, shiba, Shiba"
