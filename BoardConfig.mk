...
BOARD_ANDROID_DYNAMIC_PARTITIONS_PARTITION_LIST := system system odm_dlkm system_ext product vendor vendor_dlkm
...
BOARD_AVB_VBMETA_SYSTEM := system odm_dlkm system_ext product
